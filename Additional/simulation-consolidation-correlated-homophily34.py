...
data_folder = "./data_consol_corr_homo/"
...
if __name__ == '__main__':
    ...
    if debug_mode:
        print("Run DSIT")
    simulate(G, data_folder + 'graph_ext_' + args.extraversion + '_conf_' + args.conformity + '_simnum_' + args.sim_num + '_power_' + args.power, int(args.iterations))
