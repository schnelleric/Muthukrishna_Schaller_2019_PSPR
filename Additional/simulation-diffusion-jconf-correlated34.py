...
if __name__ == '__main__':
    ...
    if debug_mode:
        print("Run DSIT")
    simulate(G, data_folder + 'graph_corr_ext_' + args.extraversion + '_conf_' + args.conformity + '_simnum_' + args.sim_num + '_disciples_' + args.disciples  + '_power_' + args.power  + '_jesus-conf_' + args.jconf, int(args.disciples), float(args.jconf), int(args.iterations))
